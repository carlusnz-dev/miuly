...
Respeite o `AGENTS.md`: diagnostique e recomende sem alterar código de produto;
aplique correções somente quando o usuário pedir explicitamente e o escopo estiver
claro. Testes unitários e documentação de diagnóstico podem ser criados quando
solicitados.
